...
namespace AlgoSolving.Task0034_Find_First_and_Last_Position_of_Element_in_Sorted_Array
{
    public class Tests
    {
        [Test]
        ...
        {
            Assert.That(new Solution().SearchRange(new[] { 1, 4 }, 4), Is.EqualTo(new[] { 1, 1 }));
        }
